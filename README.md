...
![DHCP](https://img.shields.io/badge/DHCP-Networking-1f6feb?style=for-the-badge)
![DNS](https://img.shields.io/badge/DNS-Networking-6f42c1?style=for-the-badge)
![Packet Tracer](https://img.shields.io/badge/Cisco-Packet%20Tracer-1BA0D7?style=for-the-badge&logo=cisco&logoColor=white)
![Discord](https://img.shields.io/badge/Discord-Bot%20Development-5865F2?style=for-the-badge&logo=discord&logoColor=white)
![REST](https://img.shields.io/badge/REST-API%20Integration-009688?style=for-the-badge)
...
![DSA](https://img.shields.io/badge/Data%20Structures-%26%20Algorithms-2ea44f?style=for-the-badge)
...
```mermaid
flowchart TD
    A[Project Input] --> B[Material Estimation]
    B --> C[Quality / Quantity Selection]
    C --> D[Supplier / Cost Data]
    D --> E[AI-Assisted Budget Analysis]
    E --> F[Optimized Plan]
    F --> G[Report / Procurement Workflow]
```
...
```mermaid
flowchart LR
    U[User / Client] --> API[API / Application]
    API --> L[AWS Lambda]
    L --> D[(DynamoDB / RDS)]
    L --> S3[S3 Storage]
...
```mermaid
flowchart LR
    C[Client] --> AP[Access Point / Switch]
    AP --> R[Router]
    R --> DNS[DNS]
    R --> WAN[Internet / WAN]
    WAN --> S[Server / Cloud]
...
![AI](https://img.shields.io/badge/AI-Builder-5C2D91?style=for-the-badge)
![Game Dev](https://img.shields.io/badge/Game%20Dev-Unity%20%26%20Unreal-000000?style=for-the-badge)
![Full Stack](https://img.shields.io/badge/Full--Stack-Web%20Apps-0A66C2?style=for-the-badge)
![Cloud](https://img.shields.io/badge/Cloud-AWS-FF9900?style=for-the-badge&logo=amazonaws&logoColor=white)
![Networking](https://img.shields.io/badge/Networking-TCP%2FIP-0078D4?style=for-the-badge)
![Automation](https://img.shields.io/badge/Automation-Discord%20%26%20APIs-5865F2?style=for-the-badge&logo=discord&logoColor=white)
...
<picture>
  ...
  <img alt="GitHub contribution snake animation" src="https://raw.githubusercontent.com/mbs-x/mbs-x/gh-pages/github-contribution-grid-snake.svg">
</picture>
